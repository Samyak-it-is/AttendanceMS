...
def mode(menu):
    ...
    if(flag):
        ...
        widgets_to_transition = [
            (window, 'bg', '#000000', '#f9f9f9'),
            (frame1, 'highlightbackground', '#FFFFFF', '#000000'),
            (frame2, 'highlightbackground', '#FFFFFF', '#000000'),
            (frame1, 'bg', '#262523', '#f9f9f9'),
            (frame2, 'bg', '#262523', '#f9f9f9'),
            (frame3, 'bg', '#262523', '#f9f9f9'),
            (message3, 'bg', '#262523', '#f9f9f9'),
            (message3, 'fg', '#FFFFFF', '#000000'),
            (datef, 'bg', '#262523', '#f9f9f9'),
            (clock, 'bg', '#262523', '#f9f9f9'),
            (trainImg, 'bg', '#262523', '#f9f9f9'),
            (takeImg, 'bg', '#262523', '#f9f9f9'),
            (trackImg, 'bg', '#262523', '#f9f9f9'),
            (Att, 'bg', '#262523', '#f9f9f9'),
            (trainImg, 'fg', '#ffffff', '#000000'),
            (takeImg, 'fg', '#ffffff', '#000000'),
            (trackImg, 'fg', '#ffffff', '#000000'),
            (Att, 'fg', '#ffffff', '#000000'),
            (lbl, 'bg', "#00aeff", "#262523"),
            (lbl, 'fg', '#000000', '#ffffff'),
            (lbl2, 'bg', "#00aeff", "#262523"),
            (lbl2, 'fg', '#000000', '#ffffff'),
            (lbl3, 'bg', "#00aeff", "#262523"),
            (lbl3, 'fg', '#000000', '#ffffff'),
            (message, 'bg', "#00aeff", '#262523'),
            (message, 'fg', '#000000', '#ffffff'),
            (message1, 'bg', '#262523', '#f9f9f9'),
            (message1, 'fg', '#ffffff', '#000000'),
        ]
        ...
        # lbl['bg']="#262523"
        # transition_color(lbl, "#00aeff", "#262523", 10)
...
##################### END ######################################
window.bind("<Escape>", lambda e:psw_quit(window))
window.bind("<KeyPress-Shift_R>", lambda e:psw_quit(window))
window.protocol("WM_DELETE_WINDOW", lambda:psw_quit(window))
